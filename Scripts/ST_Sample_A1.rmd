...
Set working directory for the analysis of ST datasets. One can follow example given below: 

1) Check directory path in your working laptop[ eg. "Desktop/Projects/Workshop" ] 
2) Copy directory path into function "setwd" by calling as setwd("Desktop/Projects/Workshop")
